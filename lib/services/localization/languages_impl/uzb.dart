...
class UZB implements LanguageInterface {
  ...
  String toIndigo24Client = 'Indigo24 mijoziga';
  String transfer = 'O\'tkazish';
  String enterMessage = 'Xabarnomangizni kiriting';
  String members = 'Ishtirokchilar';
  String creator = 'Yaratuvchi';
  ...
  String sureExitGroup = 'Guruhdan chiqib ketmoqchimisiz?';
  String delete = 'O\'chirish';
  String noChatName = 'Chat nomi yo\'q';
  String minMembersCount = 'Ishtirokchilarning minimal soni: 3';
  String files = 'Fayllar';
  String edit = 'Tahrirlash';
  String editedMessage = 'Tahr.';
  String surname = 'Familiya';
  String passwordNotMatch = 'Maxfiy so\'z mos kelmayapti';
  String weSentToEmail =
      'Biz sizning raqamingizga 10 soniya ichida keladigan SMS-kalitni yubordik';
  ...
  String appVersion = 'Mobil dastur versiyasi';
  ...
  String unmute = 'Ovozni yoqing';
  String methods = 'Usullari';
  String identification = 'Aniqlash';
  String identified = 'Kashf etilgan';
  String notIdentified = 'O\'rnatilmagan';
  String simpleIdentified = 'Soddalashtirilgan identifikatsiya qilish';
  String decor = 'Tasarimnotlari';
  String decorForChat = 'Suhbat dizayn';
  String hello = 'Qanday qilib?';
  String hi = 'Salom alaykum';
  String ago = 'Ilgari';
  String days = 'Kun';
  String day = 'Kun';
  ...
  String payFrom = 'Ushbu hisob bilan to\'langan';
  String date = 'Sana';
  String destination = 'To\'lov manzili';
