...
class UZ implements LanguageInterface {
  ...
  String simpleIdentification = "Соддалаштирилган идентификатсия";
  String fullIdentification = "Тўлиқ идентификатсия қилиш";
  String afterFullIdentification =
      "Тўлиқ идентификатсия қилиш, қачонки сиз аллақачон содда тарзда аниқланган бўлсангиз";
  String currentlyNotWorking = "Ҳозир ишламаяпти";
  String infoAboutIdentification =
      "Мижозни идентификатсия қилиш тўғрисида маълумо";
  ...
  String forUserInfoHeader =
      '"Indigo24" электрон пул эгаларининг маълумотлари учун';
  String forUserInfoBody =
      '"Indigo24" электрон пул тизимининг оператори бўлган "Indigo24" ЛЛП, сизни "Indigo24" тизим эмитенти - "АзияКредит Банк" АК (АзияКредит Банк) литсензиясини бекор қилиш тўғрисида ваколатли орган томонидан қабул қилинган Қарори муносабати билан сизга хабар беради. Банк) қимматли қоғозлар бозоридаги банк ва бошқа операциялар ва фаолият учун оператор амалдаги қонунчилик талабларига мувофиқ ушбу эмитент томонидан чиқарилган электрон пуллардан фойдаланган ҳолда операцияларни тўхтатиши шарт. Шу муносабат билан "Indigo24" тизимидаги барча операциялар эмитент банк "Альфа-Банк" ОАЖ Тизимга уланмагунча тўхтатилади. Тўловни қайтариш бўйича кейинги ҳаракатлар қўшимча равишда https://indigo24.com расмий веб-сайтимизда эълон қилинади. Сизни қизиқтирган барча саволлар бўйича "АзияКредит Банк" АЖ вақтинчалик маъмуриятига қуйидаги телефонлар орқали мурожаат қилишингиз мумкин: +7 (727) 330 88 11, 355 05 35.';
  String forUserInfoFooter = 'Ҳурмат билан, "Indigo24" ЛЛП раҳбарияти.';
  String forUserInfoDear = "Ҳурматли фойдаланувчилар!";

  String alfaBank = 'Алфа-Банк';

  String asiaCreditBank = 'АО "АсиаCредит Банк (АсиаCредит Банк)"';

  String eMoneyBalance = 'Электрон пул қолдиғи';
}
