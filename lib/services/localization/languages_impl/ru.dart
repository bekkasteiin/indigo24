...
class RU implements LanguageInterface {
  ...
  String simpleIdentified = 'Упрощенная идентификация';
  ...
  String reveiverPhone = 'Телефон получателя';
  String transferAmount = 'Сумма перевода';
  ...
  String simpleIdentification = "Упрощенная идентификация";
  String fullIdentification = "Полная идентификация";
  String afterFullIdentification =
      "Полная идентификация, когда вы уже упрощенно идентифицированы";
  String currentlyNotWorking = "В настоящее время не работает";
  String infoAboutIdentification = "Идентификационная информация клиента";
  ...
  String forUserInfoHeader =
      'Для сведения владельцев электронных денег "Indigo24"';
  String forUserInfoBody =
      'ТОО "Indigo24", являющееся оператором системы электронных денег "Indigo24", уведомляет Вас, что в связи с Постановлением уполномоченного органа об отзыве лицензии у Эмитента Системы "Indigo24" - АО «АзияКредит Банк» (AsiaCredit Bank) для осуществления банковских и иных операций и деятельности на рынке ценных бумаг оператор обязан прекратить операции с использованием электронных денег, выпущенных этим эмитентом, в соответствии с требованиями действующего законодательства. В связи с этим все операции в Системе "Indigo24" будут приостановлены до момента подключения к Системе банка-эмитента ДБ «Альфа-Банк». О дальнейших действиях по возврату средств будет объявлено дополнительно на нашем официальном сайте https://indigo24.com. По всем интересующим вопросам вы можете обращаться во временную администрацию АО «АзияКредит Банк» по телефонам: +7 (727) 330 88 11, 355 05 35.';
  String forUserInfoFooter = 'С уважением, Руководство ТОО "Indigo24".';
  String forUserInfoDear = "Уважаемые Пользователи!";

  String alfaBank = 'Альфа-банк';

  String asiaCreditBank = 'АО "AsiaCredit Bank (АзияКредит Банк)"';

  String eMoneyBalance = 'Баланс электронных денег';
}
