...
String share = 'Share';
String photo = 'Photo';
String sessionDone = 'Session done';
...
String cannotFindUser = 'Cannot find user';
String file = 'File';
String addToGroup = 'Add to group';
String tapToStartChat = 'Tap to start chat';
...
String minCountOfGroup = 'Minimum count of members 3';
String files = 'Files';
String edit = 'Edit';
String editedMessage = 'Edited';
String surname = 'Surname';
String passwordsIdentical = 'Passwords must be identical';
